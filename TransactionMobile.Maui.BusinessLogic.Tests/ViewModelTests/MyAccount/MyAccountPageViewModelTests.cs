...
public class MyAccountPageViewModelTests
{
    ...
    public void MyAccountPageViewModel_OptionSelectedCommand_Logout_Execute_IsExecuted()
    {
        ...
        viewModel.OptionSelectedCommand.Execute(CreateItemSelected(MyAccountPageViewModel.AccountOptions.Logout));
    ...
    public void MyAccountPageViewModel_OptionSelectedCommand_Addresses_Execute_IsExecuted()
    {
        ...
        MyAccountPageViewModel viewModel = new MyAccountPageViewModel(navigationService.Object,
                                                                      applicationCache.Object,
                                                                      mediator.Object);
        viewModel.OptionSelectedCommand.Execute(CreateItemSelected(MyAccountPageViewModel.AccountOptions.Addresses));
    ...
    public void MyAccountPageViewModel_OptionSelectedCommand_Contacts_Execute_IsExecuted()
    {
        ...
        MyAccountPageViewModel viewModel = new MyAccountPageViewModel(navigationService.Object,
                                                                      applicationCache.Object,
                                                                      mediator.Object);
        viewModel.OptionSelectedCommand.Execute(CreateItemSelected(MyAccountPageViewModel.AccountOptions.Contacts));
    ...
    public void MyAccountPageViewModel_OptionSelectedCommand_AccountInfo_Execute_IsExecuted()
    {
        ...
        MyAccountPageViewModel viewModel = new MyAccountPageViewModel(navigationService.Object,
                                                                      applicationCache.Object,
                                                                      mediator.Object);
        viewModel.OptionSelectedCommand.Execute(CreateItemSelected(MyAccountPageViewModel.AccountOptions.AccountInfo));
    ...
    private ItemSelected<ListViewItem> CreateItemSelected(MyAccountPageViewModel.AccountOptions selectedOption)
    {
        ...
        i.SelectedItemIndex = (int)selectedOption;
        return i;
    }
}