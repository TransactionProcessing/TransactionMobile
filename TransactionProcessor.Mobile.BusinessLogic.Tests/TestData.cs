...
namespace TransactionProcessor.Mobile.BusinessLogic.Tests
{
    public static class TestData
    {
        ...
        public static ViewModels.Transactions.ProductDetails Operator1ProductDetails_ViewModel =>
            new()
            {
                ProductId = Operator1Product_100KES.ProductId,
                ContractId = Operator1Product_100KES.ContractId,
        ...
        public static ViewModels.Transactions.BillDetails BillDetails_ViewModel =>
            new()
            {
                AccountNumber = TestData.CustomerAccountNumber,
                AccountName = TestData.CustomerAccountName,
        ...
        public static ViewModels.Transactions.MeterDetails MeterDetails_ViewModel =>
            new()
            {
                MeterNumber = TestData.MeterNumber,
                CustomerName = TestData.CustomerAccountName
